                    ...
                    (props.currentUserState.data && props.currentUserState.data != null)
                        ? (
                            <div className="d-flex flex-row align-items-center float-end">
                                <img src={props.currentUserState.data.photoUrl} className="img-thumbnail rounded-circle shadow-sm me-2" alt={props.currentUserState.data.firstName + ' thumbnail'} width='48' />
